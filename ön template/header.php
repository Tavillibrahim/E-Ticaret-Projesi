		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-md-4 main-logo">
					<a href="indexx.php"><img src="images\logo.png" alt="logo" class="logo img-responsive"></a>
				</div>
				<div class="col-md-8">
					<div class="pushright">
						<div class="top">
					...
					<div class="col-md-10">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								<li><a href="indexx.php" class="active">Ana Sayfa</a><div class="curve"></div></li>
